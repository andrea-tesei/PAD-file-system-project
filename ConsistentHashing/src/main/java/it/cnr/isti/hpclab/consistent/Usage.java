...
{
	/**
	 * A {@link ConsistentHasher} stores both bucket names and members. It exposes
	 ...
	 * 
	 * The {@link ConsistentHasherImpl} exposes set of utility methods using which
	...
	public static void printBucketDistribution() 
	{
		...
		Map<Integer, Map<Double, Integer>> result = ConsistentHasherImpl.getDistributionPercentage(
						1,
						800,
						ConsistentHasher.getIntegerToBytesConverter(),
						ConsistentHasher.getIntegerToBytesConverter(),
