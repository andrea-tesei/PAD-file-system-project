...
/**
 * This object represents a timer for a gossip member. When the timer has
 * elapsed without being reset in the meantime, it will inform the GossipService
 * about this who in turn will put the gossip member on the dead list, because
 * it is apparently not alive anymore.
 */
public class GossipTimeoutTimer extends Timer 
{
	...
	/**
	 * Constructor. Creates a reset-able timer that wakes up after
	 * millisecondsSleepTime.
	 *
